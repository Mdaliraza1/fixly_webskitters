...
from .views import CustomerRegistrationView, ServiceProviderRegistrationView,RefreshAPIView, UserAPIView, UserUpdateView, ServiceProviderListView,ProviderUpdateView, LoginAPIView,LogoutAPIView
